...
<div class="col-md-12 column" style="color: black">
    <nav class="navbar navbar-default  navbar-fixed-top" role="navigation" style="width: auto">
        <div class="navbar-header">
            ...
            <a class="navbar-brand">基于无人帆船的水质检测数据系统</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" id="name" data-toggle="dropdown"><%=session.getAttribute("user")%><strong class="caret"></strong></a>
                ...
                <script>
                    function s(){
                        <%
                            session.removeAttribute("state_user");
